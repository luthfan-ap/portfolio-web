                        ...
                        <div key={category.category}>
                            ...
                            <div className="flex flex-wrap gap-2.5">
                                {category.items.map((skill) => (
                                    <span
                                        key={skill}
                                        className="px-4 py-2 text-sm font-medium text-slate-200 bg-white/5 border border-white/10 rounded-lg hover:border-primary-400/40 hover:text-primary-300 hover:bg-primary-400/5 transition-all cursor-default"
                                    >
                                        {skill}
                                    </span>
                                ))}
