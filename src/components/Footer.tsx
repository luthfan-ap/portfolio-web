export default function Footer() {
    ...
    return (
        <footer className="py-12 border-t border-black/5 dark:border-white/5 transition-colors">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <div>
                        <a
                            href="#home"
                            className="text-lg font-bold text-slate-900 dark:text-white hover:text-primary-500 dark:hover:text-primary-400 transition-colors"
                        >
                            Luthfan A.P.
                        </a>
                ...
                <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5 text-center">
                    <p className="text-xs text-slate-400 dark:text-slate-600">
                        © {currentYear} Luthfan Aryananda Purwito. Built with React &
                        Tailwind CSS.
                    </p>
                </div>
            </div>
